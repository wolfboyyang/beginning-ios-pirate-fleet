...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've awakended a sea monster! This giant marine repitle is comin' for your ships!"
        static let ComputerHitMonster = "The computer has awakended a sea monster! This giant marine repitle is comin' for the computer's ships!"
