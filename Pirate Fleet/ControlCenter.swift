...
class ControlCenter {
    ...
    func addShipsAndMines(human: Human) {
        ...
        let mine1 = Mine(location: GridLocation(x:0, y:1), explosionText: "Haha, your mine triggered!")
        let mine2 = Mine(location: GridLocation(x:4, y:3), explosionText: "Boom! Good job!")
